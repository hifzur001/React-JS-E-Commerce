...
import Vector2 from '../images/sweet-decoration.png';
import Vector3 from '../images/cupcake.png';
            ...
            <div className='relative w-650 h-400 bg-[#FFEADA] m-4 rounded-lg'>
                <div className='flex'>
                    <div className='w-1/2'>
                        ...
                        <p className='font-nunito absolute top-52 text-[16px] text-[#777] left-10'>
                    ...
                    <div className='w-1/2 ml-auto'>
                        <img src={Vector2} alt='Sweet Cupcake' />
                    </div>
                </div>
            </div>
                ...
                <div className='flex'>
                    <div className='w-1/2'>
                        <img
                            src={Vectors}
                            alt='vector'
                            className=' w-650 h-400 rounded-lg'
                        />
                        <h2 className='absolute top-24 left-10 font-garamond text-2xl text-[#bc4b68]'>
                            Up To 25% Off
                        </h2>
                    ...
                    <div className='w-1/2 ml-auto'>
                        <img src={Vector3} alt='Sweet Cupcake' />
                    </div>
                </div>
            </div>
        </div>
